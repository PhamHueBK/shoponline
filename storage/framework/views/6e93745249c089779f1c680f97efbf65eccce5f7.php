  ...
  <div class="col-md-12">
    <div class="content-panel">
      <table class="table table-striped table-advance table-hover">
       ...
       <?php echo Form::open(['method'=>'GET','url'=>'admin/review/show']); ?>
          ...
          <th colspan="4"><i class="fa fa-bullhorn">Action</i></th>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td class="hidden-phone"><?php echo e($item->email); ?></td>
                                  <td class="hidden-phone"><?php echo e($item->content); ?></td>
                                  <?php if($item->status == 0): ?>
                                  <td class="hidden-phone"><?php echo "Chưa xử lý"; ?></td>
                                  <?php else: ?> if($item->status == 1)
                                  <td class="hidden-phone"><?php echo "Đã xử lý"; ?></td>
                                  <?php endif; ?>
                                  <?php echo Form::open(['method' => 'POST', 'url' => 'admin/review/daXuLy/' . $item->id]); ?>

                                  <td>
                                    <?php echo Form::submit('Đã xử lý', ['class' => 'btn btn-success']); ?>

                                  </td>
                                  <?php echo Form::close(); ?>

                                  <?php echo Form::open(['method' => 'POST', 'url' => 'admin/review/chuaXuLy/' . $item->id]); ?>

                                  <td>
                                    <?php echo Form::submit('Chưa xử lý', ['class' => 'btn btn-warning']); ?>
                                 ...
                                 <td> 
                                  ...
                                  <?php echo Form::open(['method'=>'delete','url'=>['admin/review',$item->id]]); ?>
