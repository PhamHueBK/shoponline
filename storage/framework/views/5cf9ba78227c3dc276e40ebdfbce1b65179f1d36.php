                                                ...
                                                <figure>
                                                    <div class="snipcart-item block" >
                                                        ...
                                                        <div class="snipcart-details top_brand_home_details">
                                                            <!--<form action="<?php echo e(url('themgiohang/'.$item->id)); ?>" method="post">
                                                                <fieldset>
                                                            ...
                                                            <a href="<?php echo e(url('themgiohang/'.$item->id)); ?>" name="submit" value="" class="btn btn-success" >Thêm Vào Giỏ Hàng</a>
                                                        </div>
                                                    </div>
                                                </figure>
                                            </div>
                                                ...
                                                <figure>
                                                    <div class="snipcart-item block" >
                                                        <div class="snipcart-thumb">
                                                            ...
                                                            <h4><?php echo e($item->price - $item->discount); ?> đ<span><?php echo e($item->price); ?> đ</span></h4>
                                                            <br>
                                                            <h4 style="color: red" > <i> Tiết Kiệm <?php echo e($item->discount); ?> đ</i></h4>
                                                        </div>
                                                        <div class="snipcart-details top_brand_home_details">
