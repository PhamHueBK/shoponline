  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="<?php echo e(url('/')); ?>" class="logo"><b>DASHGUM FREE</b></a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?php echo e(asset('assets/img/ui-zac.jpg')); ?>"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?php echo e(asset('assets/img/ui-divya.jpg')); ?>"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?php echo e(asset('assets/img/ui-danro.jpg')); ?>"></span>
                                    <span class="subject">
                            ...
                            <li>
                                <a href="index.html#">
                                    <span class="photo"><img alt="avatar" src="<?php echo e(asset('assets/img/ui-sherman.jpg')); ?>"></span>
                                    <span class="subject">
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <p class="centered"><a href="profile.html"><img src="<?php echo e(asset('assets/img/ui-sam.jpg')); ?>" class="img-circle" width="60"></a></p>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo e(url('admin/product')); ?>">Show</a></li>
                          <li><a  href="<?php echo e(url('admin/product/create')); ?>">Create New Product</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo e(url('admin/category')); ?>">Show</a></li>
                          <li><a  href="<?php echo e(url('admin/category/create')); ?>">Create New Category</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="<?php echo e(url('admin/order')); ?>">Show</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                         <li><a  href="<?php echo e(url('admin/user/show')); ?>">Show</a></li>
                        <li><a  href="<?php echo e(url('admin/user/create')); ?>">Create New User</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                         <li><a  href="<?php echo e(url('admin/review/show')); ?>">Show</a></li>
                      </ul>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      <!--main content start-->
      <?php echo $__env->yieldContent('trang-chu'); ?>
