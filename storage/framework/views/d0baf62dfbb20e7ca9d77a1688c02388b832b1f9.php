...
<?php echo $__env->yieldContent('head-product-detail'); ?>
<!-- start-smoth-scrolling -->
</head>
...
<!-- header -->
	...
	<div class="logo_products">
		...
		<div class="w3l_search">
			...
			<form role="search" method="get" action="<?php echo e(route('search')); ?>">
											...
											<div class="row">
												<div class="multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6> All </h6>
														<?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<li><a href="<?php echo e(route('category',$loai->id)); ?>"><?php echo e($loai->name); ?></a></li>
      			...
      			<div class="modal-body col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
        			...
        			<?php $__currentLoopData = (Session::get('cart'))->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
							<div class="col-xs-6 col-sm-6 col-md-6">
								...
								<a href="#"><img src="uploads/product/<?php echo e($product['item']['thumbnail']); ?>" alt=""></a>
							
							</div>
							<div class="media col-xs-6 col-sm-6 col-md-6" style="padding-top: 8%">
								<div class="col-xs-10 col-sm-10 col-md-10">
									<div style="color: black" class="col-xs-12 col-sm-12 col-md-12"><?php echo e($product['item']['name']); ?></div><br>
									<div style="color: black" class="col-xs-12 col-sm-12 col-md-12">Số lượng: <?php echo e($product['count']); ?></div><br>
									<div style="color: black" class="col-xs-12 col-sm-12 col-md-12">Giá tiền: <?php echo e(number_format($product['price'])); ?></div>
								</div>
								<div class="col-xs-2 col-sm-2 col-md-2">
									<a class="cart-item-delete" href="<?php echo e(url('xoagiohang/'.$product['item']['id'])); ?>"><i class="fa fa-times"></i></a>
								</div>
					...
					<?php endif; ?>
						...
						<div class="cart-caption col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1">
							<div class="cart-total text-right" style="color: black">Tổng tiền: <span class="cart-total-value" style="color: black"><?php if(Session::has('cart')): ?><?php echo e(number_format($totalPrice)); ?> <?php else: ?> 0 <?php endif; ?>  đồng</span></div>
							<div class="clearfix"></div>

							<div class="center">
								<div class="space10">&nbsp;</div>
								<a href="<?php echo e(url('dathang')); ?>" class="btn btn-primary">Đặt hàng <i class="fa fa-chevron-right"></i></a>
							</div>
						</div>	
        			</div>
      			</div>
	...
	<div class="footer-botm">
			<div class="container">
				...
				<div class="payment-w3ls">	
					<img src="<?php echo e(asset('images/card.png')); ?>" alt=" " class="img-responsive">
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
...
<script src="<?php echo e(asset('js/minicart.min.js')); ?>"></script>
<script>
	// Mini Cart
...
<!-- main slider-banner -->
<script src="<?php echo e(asset('js/skdslider.min.js')); ?>"></script>
