                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                         ...
                         <div class="form-group<?php echo e($errors->has('gender') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <?php echo e(Form::select('gender',array(['Male'=>'Nam','Female'=>'Nữ']),['class'=>'form-control'])); ?>
                        ...
                        <div class="form-group<?php echo e($errors->has('birthday') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="birthday" type="date" class="form-control" name="birthday" value="<?php echo e(old('birthday')); ?>" required autofocus>
